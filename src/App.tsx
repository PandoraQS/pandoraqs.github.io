...
const projects: Project[] = [
  {
    ...
    icon: <Cpu size={20} />,
    repo: "https://github.com/YOUR_USERNAME/Crypto-Arbitrage-Stealth"
  },
  {
    ...
    repo: "https://github.com/YOUR_USERNAME/Sentiment-Alpha"
  },
  {
    ...
    icon: <Music size={20} />,
    repo: "https://github.com/YOUR_USERNAME/Nightcore-Player"
  },
  {
    ...
    repo: "https://github.com/YOUR_USERNAME/Behavioral-Analytics"
  }
];
    ...
    <div className="bg-[#d1d5db] min-h-screen font-sans text-slate-900 scroll-smooth">
      ...
      <section className="h-screen flex flex-col items-center justify-center text-center px-4">
        <div className="w-28 h-28 rounded-full overflow-hidden mb-6 border-4 border-white shadow-2xl transition-transform hover:scale-105 duration-300">
           <img src="https://via.placeholder.com/150" alt="Simone Micalizzi" className="w-full h-full object-cover" /> 
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <a href="#" className="flex items-center gap-2 px-6 py-2.5 bg-[#1e293b] text-white rounded-lg hover:bg-slate-800 transition shadow-lg"><Github size={18}/> GitHub</a>
          <a href="#" className="flex items-center gap-2 px-6 py-2.5 border border-slate-400 bg-white/70 rounded-lg hover:bg-white transition shadow-md"><Linkedin size={18}/> LinkedIn</a>
          <a href="mailto:your-email@example.com" className="flex items-center gap-2 px-6 py-2.5 border border-slate-400 bg-white/70 rounded-lg hover:bg-white transition shadow-md"><Mail size={18}/> Contact</a>
        </div>
        <ChevronDown className="mt-16 text-blue-800 animate-bounce" size={32} />
      </section>

      {/* ABOUT SECTION */}
      <section className="max-w-6xl mx-auto py-24 px-8 bg-white/30 rounded-[2rem] shadow-inner backdrop-blur-sm">
              ...
              <div className="group bg-white/60 p-5 rounded-2xl border border-white shadow-sm hover:shadow-md transition-all">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 italic font-semibold text-blue-900">Distributed Systems, Real-Time DSP, Electron, React</p>
                  </div>
                </div>
              </div>
              <div className="group bg-white/60 p-5 rounded-2xl border border-white shadow-sm hover:shadow-md transition-all">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 italic font-semibold text-blue-900">FinBERT NLP, ETL Pipelines, Feature Engineering, Redis</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="max-w-7xl mx-auto py-28 px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-10">
          {projects.map((p, i) => (
            <div key={i} className="group bg-white/50 rounded-3xl p-6 shadow-xl border border-white/40 flex flex-col md:flex-row gap-6 hover:bg-white/80 transition-all duration-300 transform hover:-translate-y-1">
              <div className="w-full md:w-48 h-48 bg-slate-300 rounded-2xl shrink-0 overflow-hidden shadow-md">
                <img src={`https://via.placeholder.com/400x400?text=${p.title.split(' ')[0]}`} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
              </div>
              <div className="flex flex-col flex-grow">
                ...
                <div className="flex gap-3">
                  <a href={p.repo} className="flex-1 flex items-center justify-center gap-2 py-3 bg-[#1e293b] text-white rounded-xl text-xs font-bold hover:bg-black transition-colors shadow-lg">
      ...
      <footer className="py-16 text-center text-gray-500 text-xs font-bold uppercase tracking-[0.3em] border-t border-gray-300/50">
        © 2026 Simone Micalizzi • Computer Engineer • Aarhus University
      </footer>
    </div>
  );
}